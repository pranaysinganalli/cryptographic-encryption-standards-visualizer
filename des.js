...
//   let textHex = inputText;
//   if (textInputType === 'hex') {
//     textHex = inputText.toLowerCase();
//   } else {
//     textHex = asciitohex(inputText);
//   }
...
//   if (isDecrypt) {
//     desDecryptVisualize(textHex, keyHex, rounds);  // Call your decryption visualization
//   } else {
//     desEncryptVisualize(textHex, keyHex, rounds);  // Call your encryption visualization
//   }
// }
